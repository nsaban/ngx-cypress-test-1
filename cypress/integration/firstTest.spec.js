...
describe("Our first suite", () => {
  ...
  it("Web tables", () => {
    ...
    cy.get("thead")
      ...
      .eq(2)
      .then((tableRow) => {
        cy.wrap(tableRow).find('[placeholder="First Name"]').type("Nizaam");
        cy.wrap(tableRow).find('[placeholder="Last Name"]').type("Saban");
        cy.wrap(tableRow).find(".nb-checkmark").click();
      });
    ...
    cy.get("tbody tr")
      ...
      .find("td")
      .then((tableColumns) => {
        cy.wrap(tableColumns).eq(2).should("contain", "Nizaam");
        cy.wrap(tableColumns).eq(3).should("contain", "Saban");
      });
